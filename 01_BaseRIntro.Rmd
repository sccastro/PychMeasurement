...
```{r programming for loop, echo=TRUE,results="hide"}
#Example:
tic <- Sys.time()
seq(1,1000000, by = 1)
Sys.time() - tic
...
```{r programming while loop, eval=FALSE}
