...
clssdays <- function(classday,Semester = "Spring", Year = "2025") {
  if (Semester == "Spring"){
    allclass <- seq(ymd(paste0(Year,'-01-21')),ymd(paste0(Year,'-05-09')), by = 'day')
    holidays <- c(ymd(paste0(Year,'-01-20')),ymd(paste0(Year,'-02-17')),seq.Date(from = ymd(paste0(Year,'-03-24')),to = ymd(paste0(Year,'-03-27')),by = 'day'))
...
schedule <- cbind(clssdays(classday = "Monday",Semester = "Spring",Year = "2025"),
...
"Bonus Material – Shiny?"),
      "Reading/Work" = c(paste0("syllabus ",
